...
Translater::Translater(const std::string& configpath) {
...
inline std::string Translater::ParseReg(const std::string& token) {
	return DecToNBitBin(token.substr(1, std::string::npos), 2);
}

std::string Translater::translate_line(std::string instr) {
...
std::string Translater::LoadStore(const std::vector<std::string>& tokens, bool isLoad) {
	// Instruction format:
...
std::string Translater::IntDataProcessing(const std::vector<std::string>& tokens, bool sbit) {
	// Instruction format:
...
std::string Translater::FloatDataProcessing(const std::vector<std::string>& tokens) {
